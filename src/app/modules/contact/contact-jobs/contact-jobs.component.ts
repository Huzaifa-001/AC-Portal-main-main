...
@Component({
  ...
  styleUrls: ['./contact-jobs.component.css']
})
export class ContactJobsComponent {
  ...
  constructor(private dialog: MatDialog, private router: Router, private jobService: JobService, private contactService: ContactService, private workFlowService: WorkflowService) { }
  ngOnInit() {
