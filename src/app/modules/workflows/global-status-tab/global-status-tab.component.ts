...
@Component({
  selector: 'app-global-status-tab',
  templateUrl: './global-status-tab.component.html',
  styleUrls: ['./global-status-tab.component.css']
})
export class GlobalStatusTabComponent {
  ...
  openAddWorkFlowModal(data: any): void {
    ...
    if (data == null) {
      data = {};
      data.FormTitle = 'Add Global WorkFlow';
      data.Request_Type = 'Add';
      data.workFlowType = WorkFlowType.global
      ...
      data.FormTitle = 'Edit Global WorkFlow';
